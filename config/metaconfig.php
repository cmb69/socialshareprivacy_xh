...
$plugin_mcf['socialshareprivacy']['template_call']="bool";
$plugin_mcf['socialshareprivacy']['facebook_status']="enum:on,off";
$plugin_mcf['socialshareprivacy']['facebook_perma_option']="enum:on,off";
$plugin_mcf['socialshareprivacy']['facebook_action']="enum:recommend,like";
$plugin_mcf['socialshareprivacy']['twitter_status']="enum:on,off";
