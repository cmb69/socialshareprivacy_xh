...
function socialshareprivacy_version() {
    ...
    return '<h1><a href="http://3-magi.net/?CMSimple_XH/Socialshareprivacy_XH">Socialshareprivacy_XH</a></h1>'."\n"
	    .tag('img class="socialshareprivacy_plugin_icon" src="'.$pth['folder']['plugins'].'socialshareprivacy/socialshareprivacy.png" alt="Plugin icon"')."\n"
	    ...
	    .'<p>Socialshareprivacy_XH is powered by <a href="http://www.heise.de/extras/socialshareprivacy/">socialshareprivacy</a>.'."\n"
	    .'<p class="socialshareprivacy_license">This program is free software: you can redistribute it and/or modify'
	    .' it under the terms of the GNU General Public License as published by'
	    .' the Free Software Foundation, either version 3 of the License, or'
	    .' (at your option) any later version.</p>'."\n"
	    .'<p class="socialshareprivacy_license">This program is distributed in the hope that it will be useful,'
	    .' but WITHOUT ANY WARRANTY; without even the implied warranty of'
	    .' MERCHAN&shy;TABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the'
	    .' GNU General Public License for more details.</p>'."\n"
	    .'<p class="socialshareprivacy_license">You should have received a copy of the GNU General Public License'
 ...
 * @return string  The (X)HTML.
 */
function socialshareprivacy_system_check() { // RELEASE-TODO
...
if (isset($socialshareprivacy) && $socialshareprivacy == 'true') {
    ...
    switch ($admin) {
	case '':
	    $o .= socialshareprivacy_version().tag('hr').socialshareprivacy_system_check();
	    break;
	default:
