...
<?endif?>
<?if ($reddit):?>
    <a class="socialshareprivacy_reddit" href="https://reddit.com/submit?url=<?=$this->esc($url)?>" data-share-url="https://reddit.com/submit?url=" target="_blank">
      <svg role="img" focusable="false" id="Layer_1" version="1.1" viewBox="0 0 1000 1000" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="3em" height="3em" style="padding: 0 0 0 0.1em">
        <title><?=$this->text("label_share_reddit")?></title>
        <desc><?=$this->text("alt_reddit")?></desc>
...
<?endif?>
<?if ($mastodon):?>
    <a class="socialshareprivacy_mastodon" href="https://mastodonshare.com/share?text=<?=$this->esc($url)?>" data-share-url="https://mastodonshare.com/share?text=" target="_blank">
      <svg role="img" focusable="false" height="2em" version="1.1" viewBox="0 0 512 512" width="2em" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="padding: 0.05em 0 0 0.2em;">
        <title><?=$this->text("label_share_mastodon")?></title>
        <desc><?=$this->text("alt_mastodon")?></desc>
