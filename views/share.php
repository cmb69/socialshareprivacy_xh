...
<?if ($facebook):?>
    <a class="socialshareprivacy_facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?=$this->esc($url)?>" data-share-url="https://www.facebook.com/sharer/sharer.php?u=" target="_blank">
      <svg role="img" focusable="false" enable-background="new 0 0 56.693 56.693" height="2em" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="2em" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><title>
        <?=$this->text("label_share_facebook")?></title>
        <desc><?=$this->text("alt_facebook")?></desc>
...
<?if ($x):?>
    <a class="socialshareprivacy_x" href="https://x.com/intent/post?url=<?=$this->esc($url)?>" data-share-url="https://x.com/intent/post?url=" target="_blank">
      <svg role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 1200 1227" fill="none" style="padding: 0 0 0 0.2em;">
        <title><?=$this->text("label_share_x")?></title>
        <desc><?=$this->text("alt_x")?></desc>
...
<?if ($xing):?>
    <a class="socialshareprivacy_xing" href="https://www.xing.com/social/share/spi?url=<?=$this->esc($url)?>" data-share-url="https://www.xing.com/social/share/spi?url=" target="_blank">
      <svg role="img" focusable="false" width="2em" height="2em" enable-background="new 0 0 195.3381 216" id="xing" version="1.1" viewBox="0 0 195.3381 216" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <title><?=$this->text("label_share_xing")?></title>
        <desc><?=$this->text("alt_xing")?></desc>
...
<?if ($linkedin):?>
    <a class="socialshareprivacy_linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url=<?=$this->esc($url)?>" data-share-url="https://www.linkedin.com/sharing/share-offsite/?url=" target="_blank">
      <svg enable-background="new 0 0 32 32" height="1.5em" id="Layer_1" version="1.0" viewBox="0 0 32 32" width="1.5em" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="padding: 0 0 0.1em 0.2em;">
        <title><?=$this->text("label_share_linkedin")?></title>
        <desc><?=$this->text("alt_linkedin")?></desc>
